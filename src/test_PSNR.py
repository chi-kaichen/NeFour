...
parser.add_argument('-d', '--dataset-name', help='name of dataset',choices=['UHD', 'LOLv1', 'LOLv2','our_test'], default='UHD')
parser.add_argument('-t', '--test-image-dir', help='test images path', default='./UHD/train/')
parser.add_argument('-c', '--ckpts-dir', help='ckpts path', default='./UHD/ckpts/UHDFour-epoch671-0.05400.pt')
