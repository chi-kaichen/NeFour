...
def parse_args():
    ...
    # Data parameters
    parser.add_argument('-d', '--dataset-name', help='name of dataset',choices=['UHD'], default='UHD')
    parser.add_argument('-t', '--train-dir', help='training set path', default='./UHD/train')
    parser.add_argument('-v', '--valid-dir', help='test set path', default='./UHD/valid')
    parser.add_argument('--ckpt-save-path', help='checkpoint save path', default='./UHD/ckpts')
    ...
    parser.add_argument('-e', '--nb-epochs', help='number of epochs', default=100000, type=int)
