...
class TrainData(data.Dataset):
    def __init__(self, crop_size, train_data_dir):
        ...
        train_list = train_data_dir +'data_list.txt'
    ...
    def get_images(self, index):
        ...
        lowlight = Image.open(self.train_data_dir + '/input/' + lowlight_name).convert('RGB')
        clear = Image.open(self.train_data_dir + '/gt/' + gt_name ).convert('RGB')
