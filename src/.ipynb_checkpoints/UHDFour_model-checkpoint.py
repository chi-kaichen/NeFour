...
class UHDFour(object):
    ...
    def _compile(self):
        ...
        if self.trainable: 
            ...
            self.scheduler =torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(self.optim,T_0=2,T_mult=2)
    ...
    def eval(self, valid_loader):
        ...
        for batch_idx, (source, target1,lowlight_name) in enumerate(valid_loader):
            ...
            final_result = final_result.to(source.device)
            target1 = target1.to(source.device)            
